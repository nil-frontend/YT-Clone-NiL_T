      ...
      <div className="left flex-1">
        ...
        <div className="flex">
          <div className="flex items-center">
            ...
            <button className="bg-yt-white px-4 py-2 rounded-3xl text-sm font-medium ml-3">
              Subscribe
            </button>
        ...
        <div className="text-yt-white mt-5">
          ...
          
          {
            user && (
              ...
              <button type="submit" className="bg-yt-light-black hover:bg-bg-comment px-4 py-2 rounded-3xl text-sm font-medium ml-3">
              Comment
              </button>
              </form>
            )
