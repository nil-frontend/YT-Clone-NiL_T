...
const Navbar = () => {
  ...
  return (
    <div className="bg-yt-black h-14 flex items-center pl-4 pr-5 justify-between fixed w-full z-10">
      ...
      <div className='h-10 flex flex-row item-center'>
      ...
      <div className='flex items-center justify-center'>
        <div className='flex flex-row items-center'>
            <div className='mr-2 p-2 w-10 hover:bg-yt-light-black rounded-full cursor-pointer'>
                <BiVideoPlus size={23}className='text-yt-white text-center'/>
            </div>
            <div className='mx-3 pr-2 pl-2.5 pt-2.5 pb-2.5 w-10 hover:bg-yt-light-black rounded-full cursor-pointer'>
